[![Java CI with Maven](https://github.com/lriver23/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/lriver23/spring-petclinic/actions/workflows/maven.yml)
